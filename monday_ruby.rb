...
def toonify(accent, sentence)
  ...
  # .gsub is used for substition
  elsif accent === 'elmer'
  p sentence.gsub! 'r', 'w'
  else p sentence
  end

 p toonify("daffy", "Missippi is a Southern State")
 p toonify("elmer", "Robots will run the world soon!")
 ...
 sentence = "I kind of know what I am doing"

  def word_reverse(sentence)
  break_up= sentence.split(' ')
    reverse = break_up.reverse.join(' ')
    p reverse;
  end
...
array = ["armando", "popeye", "drummond", "chicago", "cool"]
